...
import { b as buildAssetsURL, c as useRuntimeConfig, e as getResponseStatusText, f as getResponseStatus, h as defineRenderHandler, i as publicAssetsURL, a as getQuery, j as createError, k as getRouteRules, l as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Visor operativo de alumbrado público e infraestructura eléctrica municipal."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Municipalidad de Fray Mamerto Esquiú"};
